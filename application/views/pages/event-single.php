  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 mb-4">
        <img src="assets/images/events/event-single.jpg" alt="event thumb" class="img-fluid w-100">
      </div>
    </div>
    <!-- event info -->
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="media">
          <img class="mr-3 img-fluid" src="assets/images/event-speakers/speaker-1.jpg" alt="speaker">
      ...
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="media">
          <img class="mr-3 img-fluid" src="assets/images/event-speakers/speaker-2.jpg" alt="speaker">
          <div class="media-body">
      ...
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="media">
          <img class="mr-3 img-fluid" src="assets/images/event-speakers/speaker-3.jpg" alt="speaker">
          <div class="media-body">
      ...
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="media">
          <img class="mr-3 img-fluid" src="assets/images/event-speakers/speaker-4.jpg" alt="speaker">
          <div class="media-body">
