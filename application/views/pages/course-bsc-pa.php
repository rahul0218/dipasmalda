  ...
  <div class="container">
    ...
    <div class="row align-items-center mb-5">
      <div class="col-xl-3 order-1 col-sm-6 mb-4 mb-xl-0">
        <h2>B.Sc PA ( B.Sc Physician Assistantship)</h2>
      </div>
    ...
    <div class="row">
      <div class="col-12 mb-4">
        <h3>About Course</h3>
        <p>The B.S Physician Assistant is a three-year non-compulsory health care training course. 
          There are many job opportunities for graduates in this subject. Bachelor of Science in 
          Physician Assistant degree job opportunities include Cardiologist, Dietician, Medical Assistant, 
          Patient Care Specialist. Medical Assistants are trained members of the health department in 
      ...
      <!-- <div class="col-12 mb-4">
        ...
        <div class="col-12 px-0">
          <div class="row">
            <div class="col-md-12">
              <p>
              1.5 year classes in campus comprises Anatomy, Physiology,
              Electrotherapy, Massage, Exercise therapy, Rehabilitation, OrthoNeuro-General, Kinesiology, Biomechanics, Hydrotherapy,
